...
<!-- Field Table -->   
  ...
  ?>
    ...
    <div class='dropdown-menu' aria-labelledby='btnGroupDrop1'>
      <a class='dropdown-item' href='manharvestForm.php?id=".$row1[0]."'>Harvest</a>
      <a class='dropdown-item' href='maneditPlanted.php?id=".$row1[0]."'>View More/Edit</a>
      <a class='dropdown-item' onclick='if(confirm(\"Are You Sure You Want To Delete This Growing Crop?\")) location.href=\"mandeletePlanted.php?id={$row1[0]}\";'>Delete</a>
    </div>
  </div>
        </div>
      </td>"; ?>
