...
<div class="container" style="margin-left: -14px;">
  <div class="row">
    ...
    <a href="manfieldForm.php"><button type="button" class="btn btn-warning" style="width: 180px;">Create New Field</button><br > <br ></a>
    </div>
...
<!-- Field Table -->   
  ...
  <thead>
    <tr class="bg-warning">
      ...
      <th scope="col" style="border-left: none; border-right:none; border-color:#FBBC05;">Size</th>
  ...
  <?php while($row1= mysqli_fetch_array($result1)):; ?>
    ...
    <div class='dropdown-menu' aria-labelledby='btnGroupDrop1'>
      <a class='dropdown-item' href='maneditField.php?id=".$row1[0]."'>Edit</a>
      <a class='dropdown-item' onclick='if(confirm(\"Are You Sure You Want To Delete This Field And All Its Plots?\")) location.href=\"mandeleteField.php?id={$row1[0]}\";'>Delete</a>
    </div>
  </div>
        </div>
      </td>"; ?>
