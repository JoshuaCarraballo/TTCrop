...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (isset($_POST['btnSubmit'])) {
        ...
        $sql = "INSERT INTO field(fieldName, fieldAddress, fieldMaxCapacity, fieldSize, companyID) VALUES ('$fieldName', '$fieldAdd', '$maxCap', '$fieldSize','$currCompany')";
...
<body>
    ...
    <header>
        ...
        <main>
            ...
            <h2 class="dash-title">New Field Form</h2>

<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    <li class="breadcrumb-item"><a href="dashboard.php" style="color:#FBBC05;">Dashboard</a></li>
    <li class="breadcrumb-item"><a href="viewFields.php" style="color:#FBBC05;">View Fields</a></li>
    <li class="breadcrumb-item active" aria-current="page">New Field Form</li>
  </ol>
</nav>
...
<form class="form-control" method="POST" name="fieldForm">
  <div class="form-row">
    <div class="form-group col-md-6">
      ...
      <input type="text" maxlength="20" class="form-control" id="fieldName" name="fieldName" placeholder="Field 1" required>
    </div>
    <div class="form-group col-md-6">
      <label for="fieldSize">Field Size (Acreage) *</label>
      <input type="text" class="form-control" maxlength="30" id="fieldSize" name="fieldSize" placeholder="10 Acres" required>
    </div>
  </div>
  <div class="form-group">
    <label for="fieldAddress">Field Address *</label>
    <input type="text" class="form-control" maxlength="50" id="fieldAddress" name="fieldAddress" placeholder="#20 Joint-Main St" required>
  </div>
  <div class="form-group">
    <label for="maxCapacity">Max Number of Plots Field Can Hold</label>
    <input type="number" class="form-control" maxlength="30" id="maxCapacity" name="maxCapacity" placeholder="25">
  </div><br>
