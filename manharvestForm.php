    ...
    if (isset($_POST['btnSubmit'])) {
        ...
        if($connect->query($sql) === TRUE){
            ...
            if($connect->query($querySoilPrep) === TRUE){
                ...
                echo "<script> location.href='manviewPlanted.php'; alert('Error Updating Plot')</script>";
            }  
        }
        else{
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="manviewPlanted.php" style="color:#FBBC05;">View Growing Crops</a></li>
