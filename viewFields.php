...
<div class="container" style="margin-left: -14px;">
  <div class="row">
    ...
    <a href="fieldForm.php"><button type="button" class="btn btn-warning" style="width: 180px;">Create New Field</button><br > <br ></a>
    </div>
...
<!-- Field Table -->   
  ...
  <?php while($row1= mysqli_fetch_array($result1)):; ?>
    ...
    <div class='dropdown-menu' aria-labelledby='btnGroupDrop1'>
      <a class='dropdown-item' href='editField.php?id=".$row1[0]."'>Edit</a>
      <a class='dropdown-item' onclick='if(confirm(\"Are You Sure You Want To Delete This Field And All Its Plots?\")) location.href=\"deleteField.php?id={$row1[0]}\";'>Delete</a>
    </div>
  </div>
        </div>
      </td>"; ?>
