    ...
    $resultAllPlots = mysqli_query($connect, $queryAllPlots);
        ...
        if($connect->query($query) === TRUE){
            if($connect->query($sql) === TRUE){
                echo "<script> location.href='manviewFields.php'; </script>";
                echo "Deleted the data";
            }
            else{
                echo "<script> location.href='manviewFields.php'; alert('Error Deleting Field Table')</script>";
            }
        }
        else{
            echo "<script> location.href='manviewFields.php'; alert('Error Deleting Field Child Classes')</script>";
        } 
