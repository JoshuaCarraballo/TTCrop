...
<div class="container" style="margin-left: -14px;">
  <div class="row">
    ...
    <a href="plotForm.php"><button type="button" class="btn btn-warning" style="width: 180px;">Create New Plot</button><br > <br ></a>
    </div>
  ...
  <?php while($row1= mysqli_fetch_array($result1)):; ?>
    ...
    <div class='dropdown-menu' aria-labelledby='btnGroupDrop1'>
      <a class='dropdown-item' id='plant' name='plant' href='plantedForm.php?id=".$row1[0]."'>Plant Plot</a>
      <a class='dropdown-item' href='editPlot.php?id=".$row1[0]."'>Edit</a>
      <a class='dropdown-item' onclick='if(confirm(\"Are You Sure You Want To Delete This Plot?\")) location.href=\"deletePlot.php?id={$row1[0]}\";'>Delete</a>
    </div>
  </div>
        </div>
      </td>"; ?>
