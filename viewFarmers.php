...
if(isset($_POST['search'])){
    ...
    $searchQuery = "SELECT * FROM farmer WHERE companyID='$currCompany' AND farmerID LIKE '%$searchKey%' OR companyID='$currCompany' AND farmerName LIKE '%$searchKey%' OR companyID='$currCompany' AND governmentID LIKE '%$searchKey%' OR companyID='$currCompany' AND governmentIDType LIKE '%$searchKey%' OR companyID='$currCompany' AND farmerGender LIKE '%$searchKey%' OR companyID='$currCompany' AND farmerDOB LIKE '%$searchKey%' OR companyID='$currCompany' AND farmerAddress LIKE '%$searchKey%'";
    $result1 = mysqli_query($connect,$searchQuery);
}
else if(isset($_POST['asc'])){
    $sortQuery = "SELECT * FROM farmer WHERE companyID='$currCompany' ORDER BY farmerID ASC;";
    $result1 = mysqli_query($connect,$sortQuery);
}
else if(isset($_POST['desc'])){
    $sortQuery = "SELECT * FROM farmer WHERE companyID='$currCompany' ORDER BY farmerID DESC;";
    $result1 = mysqli_query($connect,$sortQuery);
}
else{
    $result1 = mysqli_query($connect,$query);
...
<body>
    ...
    <div class="main-content">
        ...
        <main>
            ...
            <h2 class="dash-title">View Farmers</h2>
...
<div class="container" style="margin-left: -14px;">
  <div class="row">
    ...
    <a href="addFarmer.php"><button type="button" class="btn btn-warning" style="width: 180px;">Add New Farmer</button><br > <br ></a>
    </div>
    ...
    <input type="submit" name="asc" class="btn btn-warning" value="Sort By Oldest" style="width: 180px;"><br ><br >
            ...
            <table class="table table-hover table-bordered box-shadow--3dp" id="farmerTable">
            
  <thead>
    <tr class="bg-warning">
      <th scope="col" style="border-right: none;">Farmer ID</th>
      <th scope="col" style="border-left: none; border-right:none;">Farmer Name</th>
      <th scope="col" style="border-left: none; border-right:none;">Government ID</th>
      <th scope="col" style="border-left: none; border-right:none;">ID Type</th>
      <th scope="col" style="border-left: none; border-right:none;">Gender</th>
      <th scope="col" style="border-left: none; border-right:none;">DOB</th>
      <th scope="col" style="border-left: none; border-right:none;">Address</th>
  ...
  <?php while($row1= mysqli_fetch_array($result1)):; ?>
    ...
    <div class='dropdown-menu' aria-labelledby='btnGroupDrop1'>
      <a class='dropdown-item' href='editFarmer.php?id=".$row1[0]."'>Edit</a>
      <a class='dropdown-item' onclick='if(confirm(\"Are You Sure You Want To Delete This Farmer?\")) location.href=\"deleteFarmer.php?id={$row1[0]}\";'>Delete</a>
    </div>
  </div>
        </div>
      </td>"; ?>
