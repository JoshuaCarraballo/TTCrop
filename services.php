            ...
            <div class="inner-sec-w3ls-agileits py-lg-5 py-3">
                ...
                <div class="row mt-lg-5 mt-md-4 mt-4">
                    ...
                    <div class="col-lg-4 about-in mt-lg-4 text-center">
                        <div class="card">
                            <div class="card-body">
                                <i class="far fa-money-bill-alt mb-4"></i>
                                <h5 class="card-title">Profitability Estimation</h5>
                                <p class="card-text">Utilizes financial analysis to estimate future profit returns.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 about-in mt-lg-4 text-center">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">Data Storage and Backups</h5>
                                <p class="card-text">Store and save all crop data with reliable and available backups securely.</p>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-4 about-in mt-lg-4 text-center">
                        <div class="card">
                            <div class="card-body">
                                <i class="fas fa-leaf mb-4"></i>
                                <h5 class="card-title">Harvesting Management</h5>
                                <p class="card-text">Dictate how and when various crops of different fields will be harvested for better organization.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 about-in mt-lg-4 text-center">
                        <div class="card">
                            <div class="card-body">
                                <i class="fas fa-code-branch mb-4"></i>
                                <h5 class="card-title">Planting Management</h5>
                                <p class="card-text">Manage where and how seeds are planted and growed.</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 about-in mt-lg-4 text-center">
                        <div class="card">
                            <div class="card-body">
                                ...
                                <h5 class="card-title">User Alerts</h5>
                                <p class="card-text">Assists with daily operations and daily deligation of tasks to workers at mass.</p>
                            </div>
                        </div>
                    </div>
