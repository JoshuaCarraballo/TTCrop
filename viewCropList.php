...
<div class="container" style="margin-left: -14px;">
  <div class="row">
    ...
    <a href="cropForm.php"><button type="button" class="btn btn-warning" style="width: 180px;">Add New Crop</button> <br><br></a>
    </div>
...
<!-- Field Table -->   
  ...
  <?php while($row1= mysqli_fetch_array($result1)):; ?>
    ...
    <div class='dropdown-menu' aria-labelledby='btnGroupDrop1'>
      <a class='dropdown-item' href='editCropList.php?id=".$row1[0]."'>Edit</a>
      <a class='dropdown-item' onclick='if(confirm(\"Are You Sure You Want To Delete This Crop?\")) location.href=\"deleteCropList.php?id={$row1[0]}\";'>Delete</a>
    </div>
  </div>
        </div>
      </td>"; ?>
