...
if($rowCheck['plotInUse'] === 'Yes' || $rowCheck['soilPreparation'] === 'No'){
  echo "<script>alert('This Plot Is Currently Unavailable For Planting!');location.href='manviewPlots.php'</script>"; 
} 
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if($connect->query($sql) === TRUE){
      ...
      header("location: manviewPlanted.php");
      }
      else{
        echo "<script> location.href='manviewPlots.php'; alert('Error Logging The Record')</script>";
      }  
    }
    else{
...
<nav aria-label="breadcrumb">
  <ol class="breadcrumb">
    ...
    <li class="breadcrumb-item"><a href="manviewPlots.php" style="color:#FBBC05;">View Plots</a></li>
